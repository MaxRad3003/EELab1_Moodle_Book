...
- **ייצוג המעגל כמערכת ליניארית ופונקציית תמסורת:** בעמוד תוכנית העבודה סודרו מחדש הפרקים, ונוסף הסבר על כתיבת המעגל כמערכת ליניארית ועל חילוץ פונקציית תמסורת \(H_C(j\omega)=V_C/V_{in}\).
