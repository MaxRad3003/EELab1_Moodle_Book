...
const chapters = [
  ...
  chapter('06_work_plan', 'Exp03_PreLab_06_WorkPlan_H5P', 'ניסוי 3 - PreLab 06: תוכנית עבודה', 'חמש שאלות על סדר עבודה, בטיחות ורישום תוצאות.', [
    ...
    q('מה חשוב לרשום לצד כל מדידה?', [a('יחידות, תחום מדידה, תדר וצורת גל כאשר רלוונטי.', true, 'נכון.'), a('רק מספר ללא יחידה.', false, 'מספר ללא יחידה אינו מספיק.'), a('רק שם הסטודנט.', false, 'לא מספיק לניתוח.'), a('רק צבע החוטים.', false, 'לא מספיק.')]),
    q('למה משנים פרמטר אחד בכל פעם?', [a('כדי להבין מה גרם לשינוי בתוצאה.', true, 'נכון. זו שיטת עבודה ניסויית מסודרת.'), a('כדי להאריך את הניסוי ללא צורך.', false, 'המטרה היא בידוד גורמים.'), a('כי אסור לשנות תדר.', false, 'מותר לפי ההנחיות.'), a('כי כל הפרמטרים שווים תמיד.', false, 'לא נכון.')]),
    q('מה עושים כאשר התצוגה באוסצילוסקופ אינה יציבה?', [a('בודקים trigger, time/div, volts/div וחיבורי גשש.', true, 'נכון.'), a('מניחים שהמעגל תקין בלי לבדוק.', false, 'יש לאבחן.'), a('מנתקים את האדמה בלבד.', false, 'זה עלול להחמיר את הבעיה.'), a('מחליפים מיד את כל הרכיבים.', false, 'קודם מאבחנים.')]),
    q('מהו כלל בטיחות מרכזי בעבודה עם שקע/מתח רשת?', [a('לא מחברים ישירות ללא ציוד מתאים ואישור מדריך.', true, 'נכון. מתח רשת מסוכן.'), a('מותר לגעת במוליכים אם המדידה קצרה.', false, 'אסור.'), a('אין צורך בבידוד.', false, 'בידוד חיוני.'), a('מתח RMS אינו מסוכן.', false, '230V RMS מסוכן מאוד.')]),
  ]),
